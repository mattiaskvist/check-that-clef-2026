...
def test_predict_accepts_use_query_extraction_argument():
    result = _run_cli("predict", "--lang", "en", "--split", "dev", "--use-query-extraction", "--help")
    assert result.returncode == 0


def test_evaluate_accepts_use_query_extraction_argument():
    result = _run_cli("evaluate", "--lang", "en", "--split", "dev", "--use-query-extraction", "--help")
    assert result.returncode == 0
