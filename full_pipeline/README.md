...
|------------------|----------|-----------------------------------|------------------------------------|---------------------------------|------------------------------------|
| DE               | 386      | 0.5660 / 0.6684 / 0.7306 / 0.8342 | 0.4048 / 0.5000 / 0.5699 / 0.6477  | 0.5278 / - / 0.7047 / -         | 0.5667 / 0.6684 / - / -            |
| FR               | 702      | 0.6732 / 0.7749 / 0.8219 / 0.8746 | 0.5446 / 0.6154 / 0.6538 / 0.7336  | 0.6318 / - / 0.7707 / -         | 0.6767 / 0.7521 / - / -            |
| EN               | 3905     | 0.6771 / 0.7746 / 0.8246 / 0.8830 | 0.5388 / 0.6151 / 0.6553 / 0.7168  | 0.6200 / - / 0.7613 / -         | 0.6734 / 0.7429 / - / -            |
| GLOBAL AVERAGE   | 4993     | 0.6680 / 0.7665 / 0.8169 / 0.8780 | 0.5293 / 0.6062 / 0.6485 / 0.7138  | 0.6146 / - / 0.7583 / -         | 0.6656 / 0.7384 / - / -            |
...
The full pipeline currently takes around 90 minutes to run end-to-end on the dev set with top_k = 10 for fusion and reranking.
