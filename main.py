...
def build_parser() -> argparse.ArgumentParser:
    ...
    predict.add_argument(
        ...
        action="store_true",
        dest="skip_query_extraction",
        help="Skip LLM tweet-structure extraction and embed raw tweet text directly (default).",
    )
    predict.add_argument(
        "--use-query-extraction",
        action="store_false",
        dest="skip_query_extraction",
        help="Enable LLM tweet-structure extraction (experimental; can reduce retrieval quality).",
    )
    predict.add_argument(
        "--output",
        default=None,
    ...
    predict.set_defaults(handler=_predict, skip_query_extraction=True)
    ...
    evaluate.add_argument(
        ...
        action="store_false",
        dest="skip_query_extraction",
        help="Enable LLM tweet-structure extraction when recomputing predictions (experimental).",
    )
    ...
    evaluate.set_defaults(handler=_evaluate, skip_query_extraction=True)
    return parser
